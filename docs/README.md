...
| Doc | Description |
|-----|-------------|
| [architecture.md](architecture.md) | Frontend, Rust backend, IPC, DB, plugins |
| [philosophy.md](philosophy.md) | Why Fishman exists and what we optimize for |
| [roadmap.md](roadmap.md) | Planned, in progress, completed, ideas |
| [code-style.md](code-style.md) | Naming and language conventions |
